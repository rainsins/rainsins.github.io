...
image:
  path: http://pan.fucku.top/img/post/southeast.jpg
  alt: sci-tool
...
- 首先下载[source file](http://pan.fucku.top/%E5%AE%89%E8%A3%85%E5%8C%85/pyenv-win-master.zip)，解压后修改文件名为`pyenv`，将其复制到`C:\Program Files\`路径下
![](http://pan.fucku.top/img/post/sci/Snipaste_2025-02-19_14-05-23.png)

- 添加`PYENV`, `PYENV_HOME` ,`PYENV_ROOT` 三个环境变量，变量值都是：`C:\Program Files\pyenv\pyenv-win`
![](http://pan.fucku.top/img/post/sci/Snipaste_2025-02-21_12-47-10.png)

- 添加`%PYENV%\bin`和`%PYENV%\shims`到`Path`中去，然后点击<kbd>确定</kbd>-><kbd>应用</kbd>。
![](http://pan.fucku.top/img/post/sci/Snipaste_2025-02-21_12-48-03.png)

- 打开终端，输入`pyenv --version`测试
![](http://pan.fucku.top/img/post/sci/Snipaste_2025-02-21_13-01-15.png)
...
用这个激活：[HEU_KMS_Activatory原仓库](https://github.com/zbezj/HEU_KMS_Activator/releases)，[HEU_KMS_Activatory直链下载](http://pan.fucku.top/%E5%AE%89%E8%A3%85%E5%8C%85/HEU_KMS_Activator_v42.3.2.rar)，下载的时候浏览器会阻止，需要你点击<kbd>保留</kbd>-><kbd>仍然保留</kbd>。
...
![](http://pan.fucku.top/img/post/sci/Snipaste_2025-02-18_20-01-46.png)
