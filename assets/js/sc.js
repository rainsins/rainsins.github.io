...
sdsd.forEach((el, index) => {
    s = s + `<link rel="stylesheet" href="https://rainsinpan.hk.cpolar.io/d/blog/font/heti/split/${el}/result.css" />`;
})
  
const sss = ["B", "D", "E", "L", "M", "R"];
let s1 = '';
sss.forEach((el, index) => {
    s1 = s1 + `<link rel="stylesheet" href="https://rainsinpan.hk.cpolar.io/d/blog/font/heti/split/FZFWZhuZiAOldMincho${el}/result.css" />`;
})
