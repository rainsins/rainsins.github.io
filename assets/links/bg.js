...
function LinksBg() {
    ...
    const item = arr.map((e, i) => {
        ...
        return (
            <div className="card" style={{ tr }}><img src={`https://source.rainsin.cn/img/post/%E5%8D%81%E4%BA%8C%E6%A2%A6_%E4%BA%AE%E7%82%B9%E6%BC%AB%E7%94%BB-%E7%AB%99%E9%85%B7ZCOOL/100${i + 1}.jpg`} />
                <h2>{i + 1}</h2>
            </div>
        );
    });
