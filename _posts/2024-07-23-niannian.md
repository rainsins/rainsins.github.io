...
> 夸克网盘，[58套](https://pan.quark.cn/s/b2e665e542ae){:target="_blank"}，提取码：ziS1ziS1，直接解压`part1`（不要在线解压），解压密码：<span data-clipboard-text="Discussion" id="nmnm-mima"> Discussion </span>。
{: .prompt-tip }
