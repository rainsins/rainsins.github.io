...
>我只提前面准备阶段的两点，因为我还没有科研经历，后面的细节本人还是一点都不知道，只能在后面经历之后再作补充。
{: .prompt-info }
...
用这个激活：[HEU_KMS_Activator](https://github.com/zbezj/HEU_KMS_Activator/releases)，下载的时候浏览器会阻止下载，需要你点击<kbd>保留</kbd>-><kbd>仍然保留</kbd>。
